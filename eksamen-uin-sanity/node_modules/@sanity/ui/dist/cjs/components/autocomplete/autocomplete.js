...
const InnerAutocomplete = (0, import_react.forwardRef)((props, ref) => {
  ...
  const handleRootBlur = (0, import_react.useCallback)(() => {
    setTimeout(() => {
      ...
      const focusInside = focusedEl && (rootElement && rootElement.contains(focusedEl) || resultsPopoverElement && resultsPopoverElement.contains(focusedEl));
      if (!focusInside) {
        setFocused(false);
        setQuery(null);
        if (onQueryChange)
  ...
  return /* @__PURE__ */ import_react.default.createElement(Root, {
    ...
    ref: setRootElement
  }, /* @__PURE__ */ import_react.default.createElement(ResultsPopover, __objSpread({
  ...
  }, popover), /* @__PURE__ */ import_react.default.createElement(import_primitives.TextInput, __objSpread(__objSpread({}, restProps), {
