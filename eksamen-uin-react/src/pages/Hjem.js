...
import { AllArticles, RelevantArticle, ArticleContent, PreviewArticle,EkstraArticles, RelevantArticlePreview, RelevantImgPreview, RelevantTextPreview, RelevantTekst, Button, MoreButton, TittelWrapper } from "../styles/HjemStyle";
...
const Hjem = () => {
    ...
    useEffect(() => {
        sanityClient
        .fetch(`*[_type == "post" && featured != false ][10..20] | order(publishedAt desc){
            title,
            slug,
            ledetekst,
            typeartikkel,
